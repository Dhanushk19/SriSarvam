      ...
      <div className="compdetails">
          <img src={logo1} alt="compname" className="comname"></img>
           ...
           <h6 className="doubt">&nbsp;<i class="fa-solid fa-phone"></i>&nbsp;9788718180</h6>
            ...
            <div className="col-sm-4">
            <h5>Address :</h5>
           <h6 className="address">&nbsp;&nbsp;<i class="fa-solid fa-location-dot"></i>&nbsp;&nbsp;Sri Vaari Electrical<br></br> Building , Karur main road ,<br></br> Kalipalayam , Dharapuram<br></br> block , Tiruppur District,<br></br> Tamil nadu - 638661 .</h6>
            </div>
            <div className="col-sm-4">
            <h5>Email :</h5>
